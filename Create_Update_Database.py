...
# I created a function that takes in a username, and creates and new user and stores the users information on 
...
def new_user(username, mypassword):
    ...
    #create in SQL
    conn = psycopg2.connect(dbname='internal_users', user='admin', password=mypassword)
    cur = conn.cursor()
    conn.autocommit = True
